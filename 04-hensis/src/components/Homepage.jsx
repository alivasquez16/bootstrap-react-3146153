      ...
      <div className='contenedor-completo' style={{height:'500vh'}}>
        ...
        <div className='seccion-03'>
          <div style={{justifyItems:'center', alignContent: 'center'}}>
            <h2 style={{fontFamily:'sans-serif', fontSize:'48px', fontWeight: 'bold'}}>Tienda</h2> <br/> <br/>
            <p>Nos tomamos el tiempo para crear con sentido. Aquí puedes ver un adelanto del proceso detrás de lo que pronto estará en tus manos.</p>
          </div> <br/>
          <div style={{padding: '2rem'}}>
            <div style={{}}>
              <img src="../public/gorra.jpeg" alt="" />
            </div> <br />
